...
if(isset($_SESSION['login_user']) && isset($_SESSION['login_phone'])){
    ...
    if($cart->total_items() > 0){ ?>
        <div style="margin-left:26px;">
                ...
                <div class="checkbox">
                    <label style="font-size:13px; color:#696969;"><input class="minus_amount grcash" type="checkbox" name="grcash" value="<?php echo $grcash; ?>"><span class="grcash_label"> ₹<?php echo $grcash; ?></span>&nbsp;<span>(GRCASH: ₹<?php echo $earned_money; ?>)</span></label>
                </div>
                <div class="checkbox">
                ...
                <?php } else { ?>
                <div class="checkbox">
                    <label style="font-size:13px; color:#696969;"><input class="minus_amount grcash" type="checkbox" name="grcash" value="<?php echo $grcash; ?>" disabled><span class="grcash_label"> ₹<?php echo $grcash; ?></span>&nbsp;<span>(GRCASH: ₹<?php echo $earned_money; ?>)</span></label>
                </div>	
                <div class="checkbox">
