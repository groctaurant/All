  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav nav1">
        ...
        <li class="disabled"><a href="#">Careers</a></li>
      </ul>
...
<div id="myCarousel" class="carousel slide" data-ride="carousel" style="margin-top:53px;">
  ...
  <a class="left carousel-control" href="#myCarousel" data-slide="prev">
    <span class="glyphicon glyphicon-chevron-left" style="left:50px"></span>
    <span class="sr-only">Previous</span>
  </a>
  <a class="right carousel-control" href="#myCarousel" data-slide="next">
    <span class="glyphicon glyphicon-chevron-right" style="right:50px"></span>
...
<div class="col-sm-7 col-sm-offset-2 mainn" id="mainn" style="min-height:760px;">
    ...
    <center><span class="lazy_loader" style="display:none;"><img src="images/load.gif" width="100%"></span></center>
...
<ul class="nav nav-tabs">
  <li class="active recname1"><a data-toggle="tab" href="#bev">Beverages</a></li>
  <li class="recname1"><a data-toggle="tab" href="#des">Desserts</a></li>
  <li class="recname1"><a data-toggle="tab" href="#brd">Breads</a></li>
</ul>

<div class="tab-content" style="margin:10px;">
  <div id="bev" class="tab-pane fade in active">
   <?php
  $queryb=mysqli_query($con,"SELECT * from admin_recipee where cuisine='Beverages' and category='Add-ons' ");
  ...
  <?php } ?>
   ...
   <?php
  $queryb=mysqli_query($con,"SELECT * from admin_recipee where cuisine='Desserts' and category='Add-ons' ");
  while($rowb=mysqli_fetch_array($queryb)){
	  $nom=$rowb['recipe_name1']; 
	  $nam=rtrim($nom,"Addon");
	  $id = $rowb['id'];
  ...
  <?php } ?>
   ...
   <?php
  $queryb=mysqli_query($con,"SELECT * from admin_recipee where cuisine='Breads' and category='Add-ons' ");
  while($rowb=mysqli_fetch_array($queryb)){
	  $nom=$rowb['recipe_name1']; 
	  $nam=rtrim($nom,"Addon");
	  $id = $rowb['id'];
...
$(document).ready(function(){
    ...
    $("#results" ).load( "cheflafetch.php"); //load initial records
    
    $(window).on( "scroll", function(e){
        e.preventDefault();
        var offset = $(".lazy_count").last().val();
        if ($(window).scrollTop() == $(document).height() - $(window).height()){
	        $.ajax({
	        	type: "POST",
	        	url: "cheflafetch.php",
	        	data: {"offset":offset, "cuisine":cuisine, "veg_tag":veg_tag},
    ...
    $(document).on( "click", ".btn_cuisine", function (e){
        ...
        $.ajax({
        	...
        	data: {"offset":offset, "cuisine":cuisine, "veg_tag":veg_tag},
        	success: function(data){
	        	$("#results").html(data); //get content from PHP page
	            	$(".cuisine_head").text(cuisine.toUpperCase());
