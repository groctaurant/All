...
?>
<?php
$sql="SELECT * from grret_orders where (ord_status='Delivered' or ord_status='Rejected' or ord_status = 'Cancelled by Merchant') and order_at >= '$date_start' and order_at <= '$date_end' order by id desc";
