  ...
  <div class="row">
    ...
    <div class="col-sm-5">
      <div class="col-sm-6">From: 
        <input type="date" id="date_start" name="date_start" min="2017-04-01" method="POST" style='border-radius:5px;' max="<?php echo date("Y-m-d"); ?>" required>
      </div>
      <div class="col-sm-6">To: 
        <input type="date" id="date_endx" name="date_end" method="POST" min="2017-04-01" style='border-radius:5px;' max="<?php echo date("Y-m-d"); ?>" required>
      </div>
    ...
    <div class="col-sm-4"><input type="text" id="search" onkeyup="myFunction()" class="form-control" placeholder="Search...." width="100%"></div>
    </div>
    <br>
    <div class="row">
    <div id="accounting_fetch">
     </div>
  </div>
...
$sql="SELECT * from grret_orders where (ord_status='Delivered' or ord_status='Rejected' or ord_status = 'Cancelled by Merchant') and order_at >= '$date_start' order by id desc";
...
<div class="container-fluid dorders <?php echo $row['ord_status']; ?>"  style="margin: 5px;">
  ...
  <div class="row" style="margin-top: 0px; margin-bottom: 0px;">
    ...
    <div class="col-sm-2">
      CGST: <?php echo $row['cgst']; ?>
      SGST: <?php echo $row['sgst']; ?>
    </div>
    <div class="col-sm-2">
      ...
      <div class="modal-content">
          ...
          <div class="modal-body">
            <form class="form-horizontal">
              ...
              <div class="form-group">
                  <label class="control-label col-sm-3">COD Cash :</label>
                  <div class="col-sm-3">
                      <input type="number" class="form-control cod_cash" style="text-align: center;" readonly>
                  </div>
                  <label class="col-sm-2">Count:</label>
                  <div class="col-sm-3">
                      <input type="number" class="form-control count_cash" style="text-align: center;" readonly>
                  </div>
              </div>
              <div class="form-group">
                  <label class="control-label col-sm-3">COD PayTM :</label>
                  <div class="col-sm-3">
                      <input type="number" class="form-control cod_paytm" style="text-align: center;" readonly>
                  </div>
                  <label class="col-sm-2">Count:</label>
                  <div class="col-sm-3">
                      <input type="number" class="form-control count_paytm" style="text-align: center;" readonly>
                  </div>
              </div>
              <div class="form-group">
                  <label class="control-label col-sm-3">COD Card :</label>
                  <div class="col-sm-3">
                      <input type="number" class="form-control cod_card" style="text-align: center;" readonly>
                  </div>
                  <label class="col-sm-2">Count:</label>
                  <div class="col-sm-3">
                      <input type="number" class="form-control count_card" style="text-align: center;" readonly>
                  </div>
              </div>
              <div class="form-group">
                  <label class="control-label col-sm-3">COD unknown:</label>
                  <div class="col-sm-3">
                      <input type="number" class="form-control cod_unknown" style="text-align: center;" readonly>
                  </div>
                  <label class="col-sm-2">Count:</label>
                  <div class="col-sm-3">
                      <input type="number" class="form-control count_unknown" style="text-align: center;" readonly>
                  </div>
              </div>
              <div class="form-group">
                  <label class="control-label col-sm-3">Pay via Wallet:</label>
                  <div class="col-sm-3">
                      <input type="number" class="form-control pay_via_wallet" style="text-align: center;" readonly>
                  </div>
                  <label class="col-sm-2">Count:</label>
                  <div class="col-sm-3">
                      <input type="number" class="form-control count_pay_via_wallet" style="text-align: center;" readonly>
                  </div>
              </div>
            </form>
          </div>
...
$(document).ready(function(){
  ...
  $.ajax({
      type: "POST",
      url: "accounting_fetch.php",
      data: "fetch=ok",
      success: function(data){
          $("#accounting_fetch").html(data);
      }
  });
  //$(".fetch_accounting").load("accounting_fetch.php");
